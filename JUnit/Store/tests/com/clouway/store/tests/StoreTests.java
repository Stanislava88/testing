...
public class StoreTests {
    ...
    public void tryToAddQuantityMoreThanMaxQuantity() throws Exception {
        store.addProduct("apple", new Product(1.20, 45, 40));
    }
    ...
    @Test(expected = IllegalArgumentException.class)
    public void tryToSellQuantityMoreThanQuantityInTheStore() throws Exception {
